...
$PBExportComments$%SPANISH% PFC DataWindow Sort service
forward
...
anv_infoattrib.is_name = 'Ordenar'
anv_infoattrib.is_description = &
	'Proporciona cuadros de di$$HEX1$$e100$$ENDHEX$$logo Ordenar para facilitar la ordenamiento de filas de DataWindow.'
