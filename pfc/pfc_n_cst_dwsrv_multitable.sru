...
$PBExportComments$%SPANISH% PFC DataWindow Multiple Table service
forward
...
anv_infoattrib.is_name = 'Multitabla'
anv_infoattrib.is_description = &
	'Facilita la actualizaci$$HEX1$$f300$$ENDHEX$$n de DataWindows que contienen filas de m$$HEX1$$e100$$ENDHEX$$s de '+&
	'de una tabla.'
