...
$PBExportComments$%SPANISH% PFC Statusbar window window
forward
...
If iw_parentwindow.inv_statusbar.of_GetMem() Then
	...
	Else
		...
		ls_modifyexp = "pfc_mem.Expression=~"'"+ "Mem: N/D'~" " + &
...
If iw_parentwindow.inv_statusbar.of_GetUser() Then
	...
	Else
		// Display NotApplicable/NotAvailable.
		ls_modifyexp = "pfc_user.Expression=~"'"+ "Usuario: N/D'~" " + &
...
If iw_parentwindow.inv_statusbar.of_GetGDI() Then
	...
	Else
		// Display NotApplicable/NotAvailable.		
		ls_modifyexp = "pfc_gdi.Expression=~"'"+ "GDI: N/D'~" " + &
