...
$PBExportComments$%SPANISH% PFC DataWindow Resize service
forward
...
anv_infoattrib.is_name = 'Cambiar tama$$HEX1$$f100$$ENDHEX$$o'
anv_infoattrib.is_description = &
	'Proporciona la funcionalidad de cambiar el tama$$HEX1$$f100$$ENDHEX$$o de cualquier objeto en proporci$$HEX1$$f300$$ENDHEX$$n a su container.'
