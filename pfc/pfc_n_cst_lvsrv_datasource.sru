...
$PBExportComments$%SPANISH% PFC ListView Datasource Service
forward
...
if al_amount = 1 then
	return of_MessageBox ("pfc_lv_datasource_confirmdeletesingle", "Confirmar eliminaci$$HEX1$$f300$$ENDHEX$$n", &
			"$$HEX1$$bf00$$ENDHEX$$Seguro que desea eliminar " + is_displayitem + "?", Question!, YesNo!, 1)
else
	return of_MessageBox ("pfc_lv_datasource_confirmdeletemulti", "Confirmar m$$HEX1$$fa00$$ENDHEX$$ltiple eliminaci$$HEX1$$f300$$ENDHEX$$n", &
