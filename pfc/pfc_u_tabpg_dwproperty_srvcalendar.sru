...
$PBExportComments$%SPANISH% PFC DataWindow Property - The Calendar service tabpage 1
forward
...
anv_infoattrib.is_name = 'Objeto calendario de propiedad de DW'
anv_infoattrib.is_description = 'Objeto calendario de propiedad de DW'
...
string text = "F&ijar el valor inicial cuando no haya ninguno disponible"
end type
...
integer height = 68
boolean bringtotop = true
string text = "Cerrar al ha&cer clic"
end type
...
integer height = 68
boolean bringtotop = true
string text = "Cerrar al hacer &doble clic"
end type
...
integer height = 68
boolean bringtotop = true
string text = "&Redise$$HEX1$$f100$$ENDHEX$$ar el calendario siempre"
end type
