...
$PBExportComments$%SPANISH% PFC DataWindow Property - The Multitable service tabpage
forward
...
anv_infoattrib.is_name = 'Servicio Multitabla de propiedad de DW'
anv_infoattrib.is_description = 'Servicio Multitabla de propiedad de DW'
...
If lb_registrationerror Then
	of_MessageBox('pfc_dwproperty_multitable_regfailed',is_msgtitle , &
		'No se pudieron registrar las siguientes tablas:~r~n'+ls_msg, StopSign!, OK!, 1)
End If	
...
If cbx_register.Checked Then
	...
	Else
		of_MessageBox('pfc_dwproperty_multitable_whereoption', is_msgtitle, &
			'Es necesario fijar la opci$$HEX1$$f300$$ENDHEX$$n Where.', StopSign!, OK!, 1)
		Return -1
	End If
	...
	Else
		of_MessageBox('pfc_dwproperty_multitable_keyoption', is_msgtitle, &
			'Es necesario fijar la opci$$HEX1$$f300$$ENDHEX$$n Key.', StopSign!, OK!, 1)
		Return -1
	End If
	...
	If lb_updatecolumns.SelectedIndex() <= 0 Then
		of_MessageBox('pfc_dwproperty_multitable_updatecol', is_msgtitle,&
			'Es necesario fijar la(s) columna(s) de la actualizaci$$HEX1$$f300$$ENDHEX$$n.', StopSign!, OK!, 1)
		Return -1
	End If
	...
	If lb_keycolumns.SelectedIndex() <= 0 Then
		of_MessageBox('pfc_dwproperty_multitable_keycol', is_msgtitle,&
			'Es necesario fijar la o las columnas clave.', StopSign!, OK!, 1)
		Return -1
	End If
End If
...
For li_cnt = 1 to li_tablecnt
	...
	// Initialize.
	ls_keycolumns = '// Columna clave para la "'+ls_table+'". ~r~nls_keycolumns = ls_initialize~r~n'
	ls_updatecolumns = '// Columnas de actualizaci$$HEX1$$f300$$ENDHEX$$n para la"'+ls_table+'". ~r~nls_updatecolumns = ls_initialize~r~n'
	li_keysubscript = 0
...
integer y = 828
integer width = 827
string text = "Columnas clave $$HEX1$$fa00$$ENDHEX$$nicas (&q)"
end type
...
integer y = 828
integer width = 850
string text = "Columnas a&ctualizables"
end type
...
integer width = 1568
integer height = 68
string text = "Column&as clave y actualizables"
end type
...
integer height = 68
boolean bringtotop = true
string text = "Colu&mnas clave y modificadas"
end type
...
integer width = 1568
integer height = 68
string text = "Usar &Eliminar e Insertar"
end type
...
integer height = 304
integer taborder = 30
string text = "Cl$$HEX1$$e100$$ENDHEX$$usula Where para Actualizar/Eliminar"
end type
...
integer height = 236
integer taborder = 40
string text = "Modificaci$$HEX1$$f300$$ENDHEX$$n de claves"
end type
