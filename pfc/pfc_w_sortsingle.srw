...
$PBExportComments$%SPANISH% PFC Simple Sort dialog window
forward
...
constant string	NONE='[Ninguno]'
constant string	ics_none='[Ninguno]'  // Obsoleted in 6.0
long		il_clickedrow
...
string	ls_currsortcol, ls_currsortdisplayname='[ninguno]'
...
integer height = 220
integer taborder = 0
string text = "Ordenar elementos por"
end type
