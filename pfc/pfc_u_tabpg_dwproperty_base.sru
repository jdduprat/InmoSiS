...
$PBExportComments$%SPANISH% PFC DataWindow Property - The TabPage Ancestor class
forward
...
anv_infoattrib.is_name = 'Objeto base de propiedad de DW'
anv_infoattrib.is_description = 'Objeto base de propiedad de DW'
...
anv_attrib.is_propertytabtext ='Sin asignar'
