...
$PBExportComments$%SPANISH% PFC DataWindow Property - The QueryMode service tabpage
forward
...
anv_infoattrib.is_name = 'Servicio QueryMode de propiedad de DW'
anv_infoattrib.is_description = 'Servicio QueryMode de propiedad de DW'
...
string text = "Qu&eryMode habilitado"
end type
...
integer height = 60
boolean bringtotop = true
string text = "Resaltar columnas que permitan entradas en QueryMode"
end type
...
integer height = 68
boolean bringtotop = true
string text = "Res&tablecer criterios de consulta cuando se cambie de QueryMode"
end type
...
integer height = 68
boolean bringtotop = true
string text = "&Recuperar cuando est$$HEX2$$e9002000$$ENDHEX$$inhabilitado QueryMode"
end type
