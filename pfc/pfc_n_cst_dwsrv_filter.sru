...
$PBExportComments$%SPANISH% PFC DataWindow Filter service
forward
...
anv_infoattrib.is_name = 'Filtro'
anv_infoattrib.is_description = &
	'Proporciona cuadros de di$$HEX1$$e100$$ENDHEX$$logo Filtrar para facilitar el filtrado de filas.'
