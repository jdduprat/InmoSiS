...
$PBExportComments$%SPANISH% PFC Calculator class
forward
...
CHOOSE CASE as_operator
	CASE '/'
		If idbl_operand = 0 Then
			of_MessageBox('pfc_calculator_dividezero', 'Divisi$$HEX1$$f300$$ENDHEX$$n', &
				'La divisi$$HEX1$$f300$$ENDHEX$$n entre cero no es v$$HEX1$$e100$$ENDHEX$$lida', Exclamation!, Ok!, 1)
			Return -1
		Else
...
anv_infoattrib.is_name = 'Calculadora'
anv_infoattrib.is_description = &
	'Ofrece los campos num$$HEX1$$e900$$ENDHEX$$ricos Datawindows y EditMask con una funci$$HEX1$$f300$$ENDHEX$$n de '+&
	'funcionalidad.'
