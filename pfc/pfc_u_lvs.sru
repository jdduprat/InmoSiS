...
$PBExportComments$%SPANISH% PFC Service Based Listview class
forward
...
If isvalid(inv_sort) then
	...
	do while li_rc = 1
		if li_index >=1 and li_index <= 10 then
			lm_view.m_viewitem.m_arrangeicons.item[li_index].text = "por " + ls_label
			lm_view.m_viewitem.m_arrangeicons.item[li_index].microhelp = "Ordena elementos por " + ls_label
...
anv_infoattrib.is_name = 'ListView basado en servicios'
anv_infoattrib.is_description = 'ListView basado en servicios'
