...
$PBExportComments$%SPANISH% PFC DataWindow Property - The Calendar service tabpage 2
forward
...
anv_attrib.is_propertytabtext ='Aspecto'
...
integer height = 340
integer taborder = 0
string text = "s$$HEX1$$e100$$ENDHEX$$bado"
end type
