...
$PBExportComments$%SPANISH% PFC DataWindow Property - The RowManager service tabpage
forward
...
anv_infoattrib.is_name = 'Servicio RowManager de propiedad de DW'
anv_infoattrib.is_description = 'Servicio RowManager de propiedad de DW'
...
integer height = 68
boolean bringtotop = true
string text = "Permitir rec&uperaci$$HEX1$$f300$$ENDHEX$$n de filas eliminadas"
end type
