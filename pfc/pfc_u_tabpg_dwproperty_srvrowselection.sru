...
$PBExportComments$%SPANISH% PFC DataWindow Property - The RowSelection service tabpage
forward
...
anv_infoattrib.is_name = 'Servicio RowSelection de propiedad de DW'
anv_infoattrib.is_description = 'Servicio RowSelection de propiedad de DW'
...
string text = "Selecci$$HEX1$$f300$$ENDHEX$$n de &teclado"
end type
...
string item[] = {"Selecci$$HEX1$$f300$$ENDHEX$$n de una sola fila","Selecci$$HEX1$$f300$$ENDHEX$$n de filas m$$HEX1$$fa00$$ENDHEX$$ltiples","Selecci$$HEX1$$f300$$ENDHEX$$n extendida de filas"}
