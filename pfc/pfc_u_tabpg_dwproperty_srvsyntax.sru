...
$PBExportComments$%SPANISH% PFC DataWindow Property - The Syntax tabpage
forward
...
anv_infoattrib.is_name = 'Pesta$$HEX1$$f100$$ENDHEX$$a Sintaxis de propiedad de DW'
anv_infoattrib.is_description = 'Pesta$$HEX1$$f100$$ENDHEX$$a Sintaxis de propiedad de DW'
...
constant string TITLE='Guardar archivo PowerScript'
