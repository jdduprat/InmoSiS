...
$PBExportComments$%SPANISH% PFC DataWindow Required Column service
forward
...
anv_infoattrib.is_name = 'Columna obligatoria'
anv_infoattrib.is_description = &
	'Este servicio habilita e inhabilita el proceso de DataWindow por omisi$$HEX1$$f300$$ENDHEX$$n en '+&
	'los campos requeridos, para que le resulte m$$HEX1$$e100$$ENDHEX$$s f$$HEX1$$e100$$ENDHEX$$cil a la aplicaci$$HEX1$$f300$$ENDHEX$$n manejar '+&
	'campos interdependientes dentro de un DataWindow.  '+&
	'Este servicio afecta solamente a las columnas de DataWindow que utilizan la propiedad nilisnull. '
