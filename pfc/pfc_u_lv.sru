...
$PBExportComments$%SPANISH% PFC ListView class
forward
...
do while li_rc = 1
	if li_index >=1 and li_index <= 10 then
		im_view.m_viewitem.m_arrangeicons.item[li_index].text = "por " + ls_label
		im_view.m_viewitem.m_arrangeicons.item[li_index].microhelp = "Ordena elementos por " + ls_label
