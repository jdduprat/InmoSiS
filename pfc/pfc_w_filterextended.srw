...
$PBExportComments$%SPANISH% PFC Extended Filter dialog window
forward
...
if this.event pfc_verify() = -1 then
	of_MessageBox ("pfc_filterextended_modifyfilter", "Filtro", &
		"El filtro no es v$$HEX1$$e100$$ENDHEX$$lido. Modifique el filtro utilizando " + &
		"funciones, columnas, operadores y valores disponibles. Es posible usar el bot$$HEX1$$f300$$ENDHEX$$n Verificar "+&
		"para determinar si el filtro es v$$HEX1$$e100$$ENDHEX$$lido.", &
		Information!, OK!, 1)
	return
end if
...
if li_rc = 1 then
	of_MessageBox ("pfc_filterextended_validverify", "Filtro", "El filtro es v$$HEX1$$e100$$ENDHEX$$lido", &
		Information!, OK!, 1)
else
	of_MessageBox ("pfc_filterextended_failedverify", "Filtro", "El filtro no es v$$HEX1$$e100$$ENDHEX$$lido", &
		Information!, OK!, 1)	
end if
end event
...
integer height = 992
integer taborder = 0
string text = "Filtro construido con"
end type
...
integer height = 368
integer taborder = 0
string text = "Expresi$$HEX1$$f300$$ENDHEX$$n de &filtrado"
end type
