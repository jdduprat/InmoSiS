...
$PBExportComments$%SPANISH% PFC DataWindow Property - The Linkage service tabpage 2
forward
...
anv_infoattrib.is_name = 'Servicio de v$$HEX1$$ed00$$ENDHEX$$nculo de las propiedades de DW'
anv_infoattrib.is_description = 'Servicio de v$$HEX1$$ed00$$ENDHEX$$nculo de las propiedades de DW'
...
anv_attrib.is_propertytabtext ='Opciones'
...
integer height = 68
integer taborder = 70
string text = "Confirm&ar antes de eliminar"
end type
...
string text = "Confirma&ci$$HEX1$$f300$$ENDHEX$$n antes de cambiar de fila"
end type
...
integer taborder = 10
boolean bringtotop = true
string text = "&Sincronizar la clave al cambiar"
end type
...
integer width = 690
boolean bringtotop = true
string text = "Act&ualizar estilo:"
end type
...
string item[] = {"TopDown","BottomUp","TopDown BottomUp","BottomUp TopDown","Personalizada"}
...
boolean bringtotop = true
boolean sorted = false
string item[] = {"Por omisi$$HEX1$$f300$$ENDHEX$$n","Eliminar filas","Descartar filas"}
...
integer taborder = 40
boolean sorted = false
string item[] = {"1","2","3","4","5","6","7","8","9","Desconocido"}
...
integer width = 690
boolean bringtotop = true
string text = "Actualizaci$$HEX1$$f300$$ENDHEX$$n personalizada: (&m)"
end type
...
integer taborder = 50
boolean bringtotop = true
string text = "Actualiza&r al cambiar de fila"
end type
