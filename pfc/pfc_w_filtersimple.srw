...
$PBExportComments$%SPANISH% PFC Simple Filter dialog window
forward
...
If Len(ls_testfilter) > 0 Then
	...
	If li_rc <> 1 Then
		...
		of_MessageBox('pfc_filtersimple_failedfilter',this.Title,'Filtro no v$$HEX1$$e100$$ENDHEX$$lido.', &
			Information!, OK!, 1)
		Return 
	End If
End If
...
string text = "Criterios de filtrado originales"
end type
...
integer width = 375
integer taborder = 20
string text = "A$$HEX1$$f100$$ENDHEX$$a&dir"
end type
...
long textcolor = 33554687
long backcolor = 82889382
string text = "Nuevos criterios de filtrado"
end type
