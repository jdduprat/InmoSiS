...
$PBExportComments$%SPANISH% PFC DataWindow Row Selection service
forward
...
anv_infoattrib.is_name = 'Selecci$$HEX1$$f300$$ENDHEX$$n de filas'
anv_infoattrib.is_description = &
	'Habilita a la DataWindow con selecci$$HEX1$$f300$$ENDHEX$$n de una sola fila, '+&
	'selecci$$HEX1$$f300$$ENDHEX$$n de m$$HEX1$$fa00$$ENDHEX$$liples filas o selecci$$HEX1$$f300$$ENDHEX$$n extendida de filas.' 
