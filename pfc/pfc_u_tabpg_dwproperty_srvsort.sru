...
$PBExportComments$%SPANISH% PFC DataWindow Property - The Sort service tabpage
forward
...
anv_infoattrib.is_name = 'Servicio Ordenar de propiedad de DW'
anv_infoattrib.is_description = 'Servicio Ordenar de propiedad de DW'
...
integer height = 68
integer taborder = 20
string text = "&Ordenar cabeceras de columnas"
end type
...
string text = "Columnas solamente &visibles"
end type
...
integer taborder = 50
boolean bringtotop = true
string text = "Utilizar los valores en pantalla para or&denar"
end type
...
integer width = 1678
boolean bringtotop = true
string text = "Resaltar columnas a excluir"
end type
...
string item[] = {"Cuadro de di$$HEX1$$e100$$ENDHEX$$logo PowerScript","Cuadro de di$$HEX1$$e100$$ENDHEX$$logo Arrastrar y colocar","Cuadro de di$$HEX1$$e100$$ENDHEX$$logo simple","Cuadro de di$$HEX1$$e100$$ENDHEX$$logo DropDownListBox"}
...
integer y = 248
integer width = 594
string text = "Sufijo para las cabeceras (&x)"
end type
