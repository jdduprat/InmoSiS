...
$PBExportComments$%SPANISH% PFC DataWindow Property - The PrintPreview service tabpage
forward
...
anv_infoattrib.is_name = 'Servicio PrintPreview de propiedad de DW'
anv_infoattrib.is_description = 'Servicio PrintPreview de propiedad de DW'
...
string text = "Pr&esentaci$$HEX1$$f300$$ENDHEX$$n preliminar"
end type
