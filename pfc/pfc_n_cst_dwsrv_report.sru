...
$PBExportComments$%SPANISH% PFC DataWindow Reporting service
forward
...
If idw_Requestor.Object.DataWindow.Units > "1" Then Return "$$HEX1$$a100$$ENDHEX$$Error! Unidad no v$$HEX1$$e100$$ENDHEX$$lida de DataWindows"

// Verify that the file exists
If Not FileExists(as_FileName) Then
	Return "$$HEX1$$a100$$ENDHEX$$Error! No se encuentra un archivo."
End if
...
// Calculate the height and width of the new object
If of_GetPictureSize(as_FileName, li_Height, li_Width) = -1 Then Return "$$HEX1$$a100$$ENDHEX$$Error! Al calcular el tama$$HEX1$$f100$$ENDHEX$$o"
...
For li_Count = 1 To li_NumObjects
	...
	If idw_Requestor.Describe(ls_Objects[li_Count] + ".type") = "line" Then
		...
		If abs(ai_XUnits) > 0 Then
			...
			If li_X < 0 Then
				Return "$$HEX1$$a100$$ENDHEX$$Error! Desplazamiento no v$$HEX1$$e100$$ENDHEX$$lido de DataWindows"
			End if
...
If ab_SizeToFit  Or ai_Height = 0 Or ai_Width = 0 Then
	...
	If of_GetPictureSize(as_FileName, ai_Height, ai_Width) = -1 Then Return "$$HEX1$$a100$$ENDHEX$$Error! Al calcular el tama$$HEX1$$f100$$ENDHEX$$o"
	If idw_Requestor.Describe("Datawindow.Units") = "1" Then
		// Convert PB units to pixels
...
If ls_Text = "!" Then
	Return "$$HEX1$$a100$$ENDHEX$$Error! Expresi$$HEX1$$f300$$ENDHEX$$n no v$$HEX1$$e100$$ENDHEX$$lida."
End if
...
li_NewLines = of_GetTextSizePos(as_Expr, as_Band, aal_HAlign, avta_VAlign, ab_Bold, &
												...
												li_Width, ai_X, ai_Y)
If li_NewLines = -1 Then Return "$$HEX1$$a100$$ENDHEX$$Error! Al calcular el tama$$HEX1$$f100$$ENDHEX$$o"
...
anv_infoattrib.is_name = 'Generaci$$HEX1$$f300$$ENDHEX$$n de informes'
anv_infoattrib.is_description = 'Facilita la creaci$$HEX1$$f300$$ENDHEX$$n de reportes y la impresi$$HEX1$$f300$$ENDHEX$$n de DataWindows.'
