...
$PBExportComments$%SPANISH% PFC Replace window
forward
...
If inv_findattrib.ipo_requestor.dynamic event pfc_findnext(inv_findattrib) = 0 Then
	of_Messagebox("pfc_replace_finishsearch", this.Title, &
		this.Title+" ha finalizado la b$$HEX1$$fa00$$ENDHEX$$squeda.", Information!, Ok!, 1)
end if
...
If ll_rc >=0 Then
	of_MessageBox("pfc_replace_finishreplace", this.Title, &
		this.Title+" ha finalizado el reemplazo "+string(ll_rc)+" elementos.", &
		Information!, Ok!, 1)
end if
...
string text = "Buscar d$$HEX1$$f300$$ENDHEX$$nd&e"
end type
...
integer height = 72
long backcolor = 79416533
string text = "Buscar qu$$HEX2$$e9002000$$ENDHEX$$(&n)"
end type
...
integer taborder = 50
long backcolor = 79416533
string text = "Pa&labra completa solamente"
end type
...
integer taborder = 60
long backcolor = 79416533
string text = "&Coincidencia de may/min  "
end type
