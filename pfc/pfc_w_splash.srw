...
$PBExportComments$%SPANISH% PFC Splash window
forward
...
int Width=1952
int Height=72
string Text="Mensaje de copyright..."
...
int Width=1472
int Height=80
string Text="mensaje de esta versi$$HEX1$$f300$$ENDHEX$$n..."
long BackColor=79741120
end type
...
int Width=1472
int Height=128
string Text="Nombre de la aplicaci$$HEX1$$f300$$ENDHEX$$n..."
long BackColor=79741120
int TextSize=-19
int Weight=700
end type
