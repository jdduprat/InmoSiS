...
$PBExportComments$%SPANISH% PFC DataWindow Property - The services tab object
forward
...
If IsValid(lw_parent) Then 
	lw_parent.Title = inv_attrib.is_objectname + ' Propiedades'
End If
...
Do While Len(as_pages) > 0
	...
	If Len(ls_page) > 0 Then
		...
		If Len(iuo_tappage[li_page].Text)=0 Then iuo_tappage[li_page].Text = 'Sin asignar'
