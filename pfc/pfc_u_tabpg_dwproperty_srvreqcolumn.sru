...
$PBExportComments$%SPANISH% PFC DataWindow Property - The ReqColumn service tabpage
forward
...
anv_infoattrib.is_name = 'Servicio DropDown de propiedad de DW'
anv_infoattrib.is_description = 'Servicio DropDown de propiedad de DW'
...
string text = "Re&saltar columnas que se deben saltar en la verificaci$$HEX1$$f300$$ENDHEX$$n"
end type
