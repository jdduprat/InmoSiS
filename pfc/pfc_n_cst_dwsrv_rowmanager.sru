...
$PBExportComments$%SPANISH% PFC DataWindow RowManager service
forward
...
if ll_rc = -2 then
	of_MessageBox ('pfc_rowmanager_norestore', gnv_app.iapp_object.displayname, &
		"No hay " + is_displayunits + " a restaurar.", Information!, Ok!, 1)
end if
...
if al_amount = 1 then
	return of_MessageBox ("pfc_rowmanager_confirmsingledelete", "Confirmar eliminaci$$HEX1$$f300$$ENDHEX$$n",  &
		"$$HEX1$$bf00$$ENDHEX$$Seguro que desea eliminar " + is_displayitem + "?", question!, yesno!, 1)
else
	return of_messageBox ("pfc_rowmanager_confirmmultipledelete","Confirmar m$$HEX1$$fa00$$ENDHEX$$ltiple eliminaci$$HEX1$$f300$$ENDHEX$$n", &
...
anv_infoattrib.is_name = 'Administrador de filas'
anv_infoattrib.is_description = &
	'Mejora la inserci$$HEX1$$f300$$ENDHEX$$n y eliminaci$$HEX1$$f300$$ENDHEX$$n de filas y facilita la restauraci$$HEX1$$f300$$ENDHEX$$n de filas eliminadas.'
