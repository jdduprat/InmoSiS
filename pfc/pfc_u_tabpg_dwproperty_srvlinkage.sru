...
$PBExportComments$%SPANISH% PFC DataWindow Property - The Linkage service tabpage 1
forward
...
// -- Master DataWindow. -- 
If Upper(st_masterdw.Text) <> 'NINGUNO' Then
...
integer width = 462
boolean bringtotop = true
string text = "Ra$$HEX1$$ed00$$ENDHEX$$z:"
end type
