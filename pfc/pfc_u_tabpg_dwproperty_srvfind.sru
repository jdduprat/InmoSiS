...
$PBExportComments$%SPANISH% PFC DataWindow Property - The Find service tabpage
forward
...
anv_infoattrib.is_name = 'Servicio Buscar/reemplazar de propiedad de DW'
anv_infoattrib.is_description = 'Servicio Buscar/reemplazar de propiedad de DW'
...
integer width = 1664
integer height = 68
string text = "Cuadro de di$$HEX1$$e100$$ENDHEX$$logo Permitir &b$$HEX1$$fa00$$ENDHEX$$squeda"
end type
...
integer width = 1664
integer height = 68
string text = "Cuad&ro de di$$HEX1$$e100$$ENDHEX$$logo Permitir reemplazo"
end type
